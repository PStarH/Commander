...
- **Run the audit-wiring script** (Tier 0.2) which checks that the *runtime* modules are wired. Saga is allowed to have 0 cross-references with `agentRuntime` because it is its own feature.
