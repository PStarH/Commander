...
**状态：PARTIAL（§5/§8 已闭环；§1 LLM worker 路径 DONE；§1 tool/connector worker 路径 L3-03a ENFORCED；遗留：API/Gateway 路径 LLM、Gateway tool token 颁发、多 isolate invoke registry）**
