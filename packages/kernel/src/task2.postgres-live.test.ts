...
// F-K2-3: this suite is the live proof of Task 2 reconciliation authority over
// real PostgreSQL. It cannot run without a PostgreSQL 16 fixture, so the skip is
// named and reported loudly — absent environment is NOT_RUN, never PASS.
const LIVE_PG_SKIP_REASON =
  'NOT VERIFIED: COMMANDER_TASK2_PG_URL is unset — Task 2 real PostgreSQL ' +
  'reconciliation authority proof did not run';
if (!adminUrl) {
...
describe(
  'Task 2 real PostgreSQL reconciliation authority',
  {
