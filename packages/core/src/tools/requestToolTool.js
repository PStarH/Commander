...
exports.createRequestToolTool = createRequestToolTool;
/**
 ...
 */
function createRequestToolTool(getToolSchema, registryTools) {
    const definition = {
        name: 'request_tool',
    ...
    return {
        ...
        async execute(args) {
            ...
            return JSON.stringify({
                ...
                examples: (_a = schema.examples) === null || _a === void 0 ? void 0 : _a.slice(0, 2), // Limit examples to save tokens
            }, null, 2);
        },
    };
}
