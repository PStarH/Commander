...
exports.CodeFixerTool = void 0;
exports.fixPythonSyntax = fixPythonSyntax;
const DEFINITION = {
    name: 'fix_code',
...
function fixPythonSyntax(code, errorHint) {
    const changes = [];
    let fixed = code;
...
class CodeFixerTool {
    constructor() {
        ...
        this.timeout = 30000; // Increased from 5s: complex code needs more time
        this.maxOutputSize = 50000;
    }
    async execute(args) {
        var _a, _b, _c;
        const code = String((_a = args.code) !== null && _a !== void 0 ? _a : '');
        const error = String((_b = args.error) !== null && _b !== void 0 ? _b : '');
        const entryPoint = String((_c = args.entryPoint) !== null && _c !== void 0 ? _c : '');
        if (!code)
...
exports.CodeFixerTool = CodeFixerTool;
