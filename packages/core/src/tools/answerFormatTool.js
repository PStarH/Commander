...
exports.AnswerFormatTool = void 0;
const DEFINITION = {
    name: 'verify_answer',
    ...
    inputSchema: {
        ...
        properties: {
            ...
            constraints: {
                type: 'string',
                description: 'Additional format constraints (e.g., "must be a single line", "no leading zeros")',
            },
        },
...
class AnswerFormatTool {
    constructor() {
        this.definition = DEFINITION;
        this.isConcurrencySafe = true;
        this.isReadOnly = true;
        this.timeout = 5000;
        this.maxOutputSize = 2000;
    }
    async execute(args) {
        var _a, _b, _c;
        const answer = String((_a = args.answer) !== null && _a !== void 0 ? _a : '');
        const format = String((_b = args.format) !== null && _b !== void 0 ? _b : 'exact_string');
        let constraints = String((_c = args.constraints) !== null && _c !== void 0 ? _c : '');
        ...
        switch (format) {
            ...
            case 'code':
                if (answer.trim().length === 0)
                    issues.push('Code answer is empty');
                break;
            case 'explanation':
...
exports.AnswerFormatTool = AnswerFormatTool;
