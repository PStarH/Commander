...
exports.CheckpointCollapseTool = exports.CheckpointListTool = exports.CheckpointRewindTool = exports.CheckpointSaveTool = void 0;
const checkpointManager_1 = require("../runtime/checkpointManager");
// ============================================================================
...
Returns a checkpoint ID for later use with checkpoint_rewind.`,
            inputSchema: {
                ...
                properties: {
                    label: {
                        type: 'string',
                        description: 'Human-readable label for this checkpoint (e.g., "before refactor", "approach A")',
                    },
                    messages: {
                        type: 'array',
    ...
    async execute(args) {
        var _a, _b, _c, _d, _e;
        const label = String((_a = args.label) !== null && _a !== void 0 ? _a : 'unnamed');
        const messages = ((_b = args.messages) !== null && _b !== void 0 ? _b : []);
        const stepNumber = Number((_c = args.stepNumber) !== null && _c !== void 0 ? _c : 0);
        const filesRead = ((_d = args.filesRead) !== null && _d !== void 0 ? _d : []);
        const filesModified = ((_e = args.filesModified) !== null && _e !== void 0 ? _e : []);
...
exports.CheckpointSaveTool = CheckpointSaveTool;
// ============================================================================
// Checkpoint Rewind Tool
// ============================================================================
class CheckpointRewindTool {
    constructor() {
        this.definition = {
...
Returns the restored messages.`,
    ...
    async execute(args) {
        var _a;
        const checkpointId = String((_a = args.checkpointId) !== null && _a !== void 0 ? _a : '');
        if (!checkpointId)
...
exports.CheckpointRewindTool = CheckpointRewindTool;
// ============================================================================
...
exports.CheckpointListTool = CheckpointListTool;
// ============================================================================
// Checkpoint Collapse Tool
// ============================================================================
class CheckpointCollapseTool {
    constructor() {
        this.definition = {
...
exports.CheckpointCollapseTool = CheckpointCollapseTool;
