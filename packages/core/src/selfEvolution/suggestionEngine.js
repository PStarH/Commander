...
exports.suggestUpgradeModel = suggestUpgradeModel;
function generateSuggestions(context) {
    const suggestions = [];
    const { modelPerformance, strategyRanking, perModelPriors, regressionEvents, reflections, minSamplesForSuggestion, enableCrossModelMemory, } = context;
...
function suggestUpgradeModel(currentModelId) {
    var _a;
    const upgrades = {
        // Claude family
    ...
    return (_a = upgrades[currentModelId]) !== null && _a !== void 0 ? _a : 'claude-sonnet-4-6';
}
