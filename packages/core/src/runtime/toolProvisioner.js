...
exports.provisionTools = provisionTools;
...
// ============================================================================
async function provisionTool(config, goal, request, tools, toolCache) {
    ...
    try {
        ...
        (0, logging_1.getGlobalLogger)().debug('AgentRuntime', `Provision ${config.toolName} failed`, {
...
const PROVISION_CONFIGS = [
    ...
    },
    {
        ...
        buildArgs: (goal) => {
            ...
            return { path: (_a = fileMatch === null || fileMatch === void 0 ? void 0 : fileMatch[1]) !== null && _a !== void 0 ? _a : '' };
        },
    ...
    },
    {
        ...
        buildArgs: (goal) => {
            ...
            const pattern = (_a = patternMatch === null || patternMatch === void 0 ? void 0 : patternMatch[1]) !== null && _a !== void 0 ? _a : goal
 ...
 */
async function provisionTools(goal, request, tools, toolCache) {
    const { bestIntent } = (0, taskAnalyzer_1.classifyProvisionIntent)(goal);
    if (!bestIntent)
        return false;
