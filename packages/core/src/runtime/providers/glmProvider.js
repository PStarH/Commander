...
class GLMProvider {
    constructor(config) {
        ...
        this.baseUrl = (_a = config.baseUrl) !== null && _a !== void 0 ? _a : 'https://open.bigmodel.cn/api/paas/v4';
        this.defaultModel = (_b = config.defaultModel) !== null && _b !== void 0 ? _b : 'glm-4.7';
    }
    async call(request) {
        var _a, _b;
    ...
    buildBody(request, model) {
        ...
        if (request.tools && request.tools.length > 0) {
            body.tools = formatBridge_1.FormatBridge.adaptToolsForProvider(request.tools, 'glm');
    ...
    async handleStreamingResponse(response, model) {
        ...
        if (!reader)
            throw new Error('GLM: No response body from streaming endpoint');
        let content = '';
        ...
        while (true) {
            ...
            for (const line of lines) {
                ...
                try {
                    ...
                    (0, logging_1.getGlobalLogger)().debug('GLMProvider', 'Skipping malformed stream chunk', {
