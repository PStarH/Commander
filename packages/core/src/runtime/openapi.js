...
exports.openApiSpec = {
    ...
    servers: [
        {
            url: `http://localhost:${(_a = process.env.COMMANDER_PORT) !== null && _a !== void 0 ? _a : '3001'}`,
            description: 'Default development server',
        },
        { url: `http://localhost:${(_b = process.env.PORT) !== null && _b !== void 0 ? _b : '4000'}`, description: 'Production API server' },
    ],
    paths: {
        '/health': {
            get: {
