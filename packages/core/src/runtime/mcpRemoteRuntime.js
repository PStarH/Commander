...
exports.MCPRemoteRuntime = void 0;
...
class MCPRemoteRuntime {
    ...
    async execute(ctx) {
        ...
        try {
            ...
            if (result.isError) {
                const errorText = result.content.map((c) => { var _a; return (_a = c.text) !== null && _a !== void 0 ? _a : ''; }).join('\n');
                steps.push({
                    stepNumber: 1,
            ...
            const outputText = result.content.map((c) => { var _a; return (_a = c.text) !== null && _a !== void 0 ? _a : ''; }).join('\n');
            steps.push({
                stepNumber: 1,
                timestamp: new Date().toISOString(),
                type: 'response',
...
exports.MCPRemoteRuntime = MCPRemoteRuntime;
