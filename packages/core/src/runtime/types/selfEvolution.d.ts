 ...
 */
export type FailureCategory = 'tool_misuse' | 'context_overflow' | 'timeout' | 'model_refusal' | 'missing_capability' | 'planning_error' | 'hallucination' | 'dependency_failure' | 'quality_gate' | 'rate_limit' | 'authentication' | 'resource_exhaustion' | 'data_validation' | 'unclassified';
/**
