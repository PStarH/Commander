 ...
 */
export declare function getToolTags(_toolName: string): string[];
/**
 ...
 */
export declare function getToolCost(_toolName: string): number | undefined;
/**
...
export type PlanStepStatus = 'pending' | 'running' | 'succeeded' | 'failed' | 'skipped' | 'requires_approval';
