...
// DEPRECATED: This file was moved from orchestration/ to legacy/.
// The InMemoryAgentExecutor returns mock data. For real LLM calls, use AgentRuntimeExecutor.
// This file is not compiled or used in production.
...
interface SequentialStepResult {
  stepId: string;
  agentId: string;
...
interface SequentialPipelineRun {
  pipelineId: string;
  executionId: string;
...
interface SequentialEventHandler {
 ...
 * Uses InMemoryAgentExecutor by default (mock). For real LLM calls,
 * implement AgentExecutor and pass it in.
 */
