...
exports.Timer = exports.MetricsCollector = exports.Logger = void 0;
...
class MetricsCollector {
    ...
    getLatest(name) {
        ...
        return metric === null || metric === void 0 ? void 0 : metric.values[metric.values.length - 1];
    }
    /**
...
const loggerSingleton = (0, tenantAwareSingleton_1.createTenantAwareSingleton)(() => new Logger());
