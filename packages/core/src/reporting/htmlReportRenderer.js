...
exports.HTMLReportRenderer = void 0;
exports.getHTMLReportRenderer = getHTMLReportRenderer;
exports.resetHTMLReportRenderer = resetHTMLReportRenderer;
exports.createWarRoomHTMLReport = createWarRoomHTMLReport;
...
class HTMLReportRenderer {
    ...
    renderContent(report) {
      ...
      <div class="report-header">
        <div class="report-eyebrow">${this.escapeHtml((_a = report.metadata['type']) !== null && _a !== void 0 ? _a : 'Report')}</div>
...
exports.HTMLReportRenderer = HTMLReportRenderer;
const tenantAwareSingleton_1 = require("../runtime/tenantAwareSingleton");
const htmlReportRendererSingleton = (0, tenantAwareSingleton_1.createTenantAwareSingleton)(() => new HTMLReportRenderer());
function getHTMLReportRenderer() {
    return htmlReportRendererSingleton.get();
}
function resetHTMLReportRenderer() {
    htmlReportRendererSingleton.reset();
}
function createWarRoomHTMLReport(params) {
    ...
    const sections = [
        ...
        },
        {
            ...
            content: params.topAgents.length > 0
                ? renderer.renderTable(['Agent', 'Missions Completed'], params.topAgents.map((a) => [
                    a.name,
                    String(a.completed),
