...
exports.getLLMAPIDomains = getLLMAPIDomains;
exports.generateProxyScript = generateProxyScript;
exports.writeProxyScript = writeProxyScript;
exports.wrapCommandWithProxy = wrapCommandWithProxy;
 ...
 */
function generateProxyScript(allowDomains) {
 ...
 */
function writeProxyScript(allowDomains) {
 ...
 */
function wrapCommandWithProxy(command, scriptPath = '/proxy.js', proxyPort = PROXY_PORT) {
