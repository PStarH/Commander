...
const SYS = {
  ...
  fork: 57, execve: 59, exit: 60, wait4: 61, kill: 62,
  getcwd: 79, chdir: 80, mkdir: 83, rmdir: 84, unlink: 87,
  readlink: 89, getuid: 102, getgid: 104, geteuid: 107, getegid: 108,
  getppid: 110, getpgrp: 111, setsid: 112, setpgid: 109,
  arch_prctl: 158, futex: 202, set_tid_address: 218,
  clock_gettime: 228, exit_group: 231, epoll_wait: 232,
  epoll_ctl: 233, tgkill: 234, openat: 257, mkdirat: 258,
  newfstatat: 262, unlinkat: 263, readlinkat: 267,
  getrandom: 318, pipe2: 293, dup3: 292,
  pread64: 17, pwrite64: 18, readv: 19, writev: 20,
  fcntl: 72, fadvise64: 221, getdents64: 217,
  rt_sigaction: 13, rt_sigprocmask: 14, rt_sigreturn: 15,
  gettid: 186,
  set_robust_list: 273, get_robust_list: 274,
  mremap: 25, madvise: 28, msync: 26,
  prlimit64: 302, getrusage: 98, times: 100,

  // Network (conditional)
  socket: 41, connect: 42, bind: 49, listen: 50, accept4: 288,
  sendto: 44, recvfrom: 45, setsockopt: 54, getsockopt: 55,
  shutdown: 48, getsockname: 51, getpeername: 52,
...
const SYS_AARCH64 = {
  read: 63, write: 64, close: 57, fstat: 80, mmap: 222,
  mprotect: 226, munmap: 215, brk: 214, ioctl: 29,
  access: 2064, pipe2: 594, select: 65, sched_yield: 124,
  dup: 23, dup2: 23, nanosleep: 101, getpid: 172, clone: 220,
  fork: 220, execve: 221, exit: 93, wait4: 260, kill: 129,
  getcwd: 17, chdir: 49, mkdir: 34, rmdir: 35, unlink: 35,
  readlink: 78, getuid: 174, getgid: 176, geteuid: 175, getegid: 177,
  getppid: 173, setsid: 157, arch_prctl: 0xffffffff, // not on aarch64
  futex: 98, set_tid_address: 96, clock_gettime: 113,
  exit_group: 94, epoll_wait: 22, epoll_ctl: 21, tgkill: 131,
  openat: 56, mkdirat: 34, newfstatat: 79, unlinkat: 35,
  readlinkat: 78, getrandom: 278, dup3: 24,
  rt_sigaction: 134, rt_sigprocmask: 135,
  rt_sigreturn: 139, gettid: 178, set_robust_list: 99,
  get_robust_list: 100, mremap: 216, madvise: 233,
  prlimit64: 261, getrusage: 165, times: 153,
  socket: 198, connect: 203, bind: 200, listen: 201, accept4: 242,
  sendto: 206, recvfrom: 207, setsockopt: 208, getsockopt: 209,
  shutdown: 210, getsockname: 204, getpeername: 205,
...
export function buildSeccompFilter(options: SeccompFilterOptions = {}): Buffer {
  ...
  // Core I/O
  for (const name of ['read', 'write', 'close', 'lseek', 'pread64', 'pwrite64',
    'readv', 'writev', 'ioctl', 'fcntl', 'access', 'fstat', 'stat', 'lstat',
    'newfstatat', 'readlink', 'readlinkat', 'getdents64',
    'open', 'openat', 'poll', 'select', 'dup', 'dup2', 'dup3', 'pipe', 'pipe2',
    'mmap', 'munmap', 'mprotect', 'mremap', 'madvise', 'brk', 'msync',
    'fadvise64']) {
    addSyscall(name);
  }

  // Process management
  for (const name of ['exit', 'exit_group', 'getpid', 'getppid', 'gettid',
    'getuid', 'getgid', 'geteuid', 'getegid', 'getpgrp',
    'wait4', 'getrusage', 'times',
    'setsid', 'setpgid', 'getcwd', 'chdir',
    'set_tid_address', 'set_robust_list', 'get_robust_list',
    'arch_prctl', 'futex', 'sched_yield',
    'rt_sigaction', 'rt_sigprocmask', 'rt_sigreturn',
    'prlimit64', 'getrandom', 'nanosleep', 'clock_gettime',
    'tgkill', 'kill']) {
    addSyscall(name);
  }
  ...
  if (options.allowNetwork) {
    for (const name of ['socket', 'connect', 'bind', 'listen', 'accept4',
...
export function countAllowedSyscalls(options: SeccompFilterOptions = {}): number {
  ...
  for (const name of ['exit', 'exit_group', 'getpid', 'getppid', 'gettid',
    'getuid', 'getgid', 'geteuid', 'getegid', 'wait4', 'getrusage', 'times',
    'setsid', 'getcwd', 'chdir', 'set_tid_address', 'set_robust_list',
    'arch_prctl', 'futex', 'sched_yield', 'rt_sigaction', 'rt_sigprocmask',
    'rt_sigreturn', 'prlimit64', 'getrandom', 'nanosleep', 'clock_gettime',
    'tgkill', 'kill']) {
    addIfValid(name);
  }
  if (options.allowProcessCreation !== false) {
