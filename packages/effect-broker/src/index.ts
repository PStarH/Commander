...
export class CapabilityTokenIssuer {
  ...
  get publicKey(): KeyObject {
    // @ts-expect-error — createPublicKey accepts a KeyObject at runtime to
    // derive the public key; @types/node@26 narrowed the parameter union and
    // dropped KeyObject. If a future @types/node re-adds it, this directive
    // will error and should be removed.
