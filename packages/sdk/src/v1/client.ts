...
/** Gateway error detail recorded on action errors / evidence receipts. */
...
/** A reconcile acceptance returned by the gateway. */
...
export type KillSwitchScope = 'tool' | 'destination' | 'tenant' | 'package' | 'model';
...
export class CommanderGatewayClient {
  ...
  async reconcileAction(runId: string, idempotencyKey: string): Promise<ReconcileActionResult> {
