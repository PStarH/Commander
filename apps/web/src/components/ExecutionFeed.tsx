    ...
    <div className="execution-feed">
      ...
      <div className="log-timeline">
        ...
        {filteredLogs.map((log, i) => {
          ...
          return (
            <div key={log.id}>
              {showDateSep && i > 0 && <div className="log-date-sep">{currDate}</div>}
              <div
                className="log-entry"
                style={{ borderLeftColor: logColors[log.level] || logColors.INFO }}
              >
                <div
                  className="log-badge"
                  style={{
                ...
                <div className="log-content">
                  ...
                  <div className="log-meta">
                    ...
                    <span>·</span>
                    <span>
                      {missions.find((m) => m.id === log.missionId)?.title || log.missionId}
                    </span>
                    <span>·</span>
