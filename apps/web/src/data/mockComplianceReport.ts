...
export function generateMockReport(): ComplianceAuditReport {
  ...
  const trend: TrendAnalysis = {
    ...
    scoreDeltaRecent: currentPosture.overallScore - history[history.length - 6]?.posture.overallScore ?? 0,
    trend: 'improving',
    averageScore: Math.round(history.reduce((s, h) => s + h.posture.overallScore, 0) / history.length),
...
function buildPosture(overallScore: number, timestamp: string): SecurityPosture {
  const dims: DimensionScore[] = [
    {
      ...
      controls: [
        { id: 'CTL-001', name: 'Content Scanning', description: 'Prompt injection detection (5-language)', isoClauses: ['8.2', '8.3'], nistSubcategories: ['MEASURE-2.1', 'MEASURE-2.2'], effectivenessScore: 85, automated: true },
        { id: 'CTL-002', name: 'Tool Output Scanning', description: 'Injection check on tool results', isoClauses: ['8.2', '8.3'], nistSubcategories: ['MEASURE-2.2'], effectivenessScore: 80, automated: true },
    ...
    },
    {
      ...
      controls: [
        { id: 'CTL-004', name: 'Sandbox Manager', description: 'OS-level isolation (Seatbelt/Bubblewrap/Docker)', isoClauses: ['8.1', '8.3'], nistSubcategories: ['MANAGE-2.1'], effectivenessScore: 90, automated: true },
    ...
    },
    {
      ...
      controls: [
        { id: 'CTL-007', name: 'Guardian Agent', description: 'Single-agent behavioral anomaly detection', isoClauses: ['9.1', '9.2'], nistSubcategories: ['MEASURE-2.1'], effectivenessScore: 82, automated: true },
        { id: 'CTL-008', name: 'Security Monitor', description: 'Continuous event monitoring + alerting', isoClauses: ['9.1', '9.2'], nistSubcategories: ['MEASURE-2.4'], effectivenessScore: 80, automated: true },
        { id: 'CTL-009', name: 'Circuit Breaker', description: 'Provider failure protection (5 failures → 30s open)', isoClauses: ['8.1', '9.1'], nistSubcategories: ['MANAGE-2.2', 'MEASURE-2.1'], effectivenessScore: 85, automated: true },
        { id: 'CTL-024', name: 'Cross-Agent Correlator', description: 'Multi-agent attack chain detection (6 rules)', isoClauses: ['9.1', '9.2'], nistSubcategories: ['MEASURE-2.1', 'MEASURE-2.4'], effectivenessScore: 78, automated: true },
      ],
    ...
    },
    {
      ...
      controls: [
        { id: 'CTL-010', name: 'Supply Chain Scanner', description: 'Malware signature detection (8 static sigs)', isoClauses: ['8.2', '8.3'], nistSubcategories: ['MAP-3.1', 'MEASURE-2.3'], effectivenessScore: 78, automated: true },
        { id: 'CTL-011', name: 'Agent Lineage', description: 'Immutable parent-child tracking', isoClauses: ['8.1', '9.1'], nistSubcategories: ['GOVERN-3.1', 'MAP-2.2'], effectivenessScore: 85, automated: true },
        { id: 'CTL-012', name: 'Capability Token', description: 'HMAC-signed authorization', isoClauses: ['8.1', '8.3'], nistSubcategories: ['GOVERN-3.1'], effectivenessScore: 88, automated: true },
        { id: 'CTL-025', name: 'Threat Intel Feed', description: 'Dynamic threat feed (TLP 4-level, 8 emerging sigs)', isoClauses: ['8.2', '8.3'], nistSubcategories: ['MAP-3.1', 'MEASURE-2.3'], effectivenessScore: 76, automated: true },
      ],
    ...
    },
    {
      ...
      controls: [
        { id: 'CTL-013', name: 'CostGuard', description: 'Economic attack detection', isoClauses: ['8.1', '9.1'], nistSubcategories: ['MEASURE-2.1', 'MANAGE-2.2'], effectivenessScore: 85, automated: true },
        { id: 'CTL-014', name: 'Token Governor', description: 'Budget enforcement', isoClauses: ['8.1', '9.1'], nistSubcategories: ['MEASURE-2.1'], effectivenessScore: 82, automated: true },
      ],
    ...
    },
    {
      ...
      controls: [
        { id: 'CTL-015', name: 'AgentSOC', description: 'Incident response operations', isoClauses: ['9.1', '9.2', '10.1'], nistSubcategories: ['MANAGE-3.1', 'MANAGE-4.1'], effectivenessScore: 80, automated: true },
        { id: 'CTL-016', name: 'Standby Manager', description: 'Hot standby failover', isoClauses: ['8.1', '8.3'], nistSubcategories: ['MANAGE-2.2'], effectivenessScore: 82, automated: true },
        { id: 'CTL-017', name: 'AuditChainLedger', description: 'Tamper-evident audit trail', isoClauses: ['7.5', '9.1', '9.2'], nistSubcategories: ['GOVERN-5.1', 'MEASURE-3.1'], effectivenessScore: 90, automated: true },
    ...
    },
    {
      ...
      controls: [
        { id: 'CTL-026', name: 'Post-Quantum Crypto', description: 'PQ-safe hash (SHA-512 double-hash) + HMAC MAC (512-bit keys)', isoClauses: ['8.1', '8.3'], nistSubcategories: ['GOVERN-3.1', 'MANAGE-2.1'], effectivenessScore: 82, automated: true },
        { id: 'CTL-027', name: 'Federated Identity', description: 'Cross-org trust delegation (HMAC+OIDC JWT)', isoClauses: ['8.1', '8.3'], nistSubcategories: ['GOVERN-3.1'], effectivenessScore: 85, automated: true },
      ],
    ...
    },
    {
      ...
      controls: [
        { id: 'CTL-028', name: 'Fuzz Test Framework', description: 'Mutation-based tool input fuzzer (6 strategies, coverage-guided)', isoClauses: ['9.1', '9.2'], nistSubcategories: ['MEASURE-2.4', 'MEASURE-3.1'], effectivenessScore: 80, automated: true },
      ],
  ...
  return {
    ...
    topRisks: dims.slice().sort((a, b) => a.score - b.score).slice(0, 2).map(d => `${d.label}: ${d.score}/100`),
    topStrengths: dims.slice().sort((a, b) => b.score - a.score).slice(0, 2).map(d => `${d.label}: ${d.score}/100`),
  };
}
...
function buildIsoCoverage(): IsoComplianceSummary {
  const allClauses: IsoClause[] = ['6.1', '6.2', '7.1', '7.2', '7.3', '7.4', '7.5', '8.1', '8.2', '8.3', '9.1', '9.2', '9.3', '10.1', '10.2'];
  const coverage: Record<string, IsoCoverageEntry> = {};
  const covered = ['6.1', '6.2', '7.1', '7.2', '7.3', '7.4', '7.5', '8.1', '8.2', '8.3', '9.1', '9.2', '10.1', '10.2'];
...
function buildNistAlignment(): NistRmfAlignmentSummary {
  return {
    functionCoverage: {
      GOVERN: { coveredSubcategories: 6, totalSubcategories: 8, coveragePercentage: 75, controls: ['CTL-005', 'CTL-011', 'CTL-012', 'CTL-017', 'CTL-020'] },
      MAP: { coveredSubcategories: 5, totalSubcategories: 7, coveragePercentage: 71, controls: ['CTL-003', 'CTL-010', 'CTL-011'] },
      MEASURE: { coveredSubcategories: 8, totalSubcategories: 8, coveragePercentage: 100, controls: ['CTL-001', 'CTL-002', 'CTL-007', 'CTL-008', 'CTL-013', 'CTL-014', 'CTL-018', 'CTL-019'] },
      MANAGE: { coveredSubcategories: 6, totalSubcategories: 8, coveragePercentage: 75, controls: ['CTL-004', 'CTL-006', 'CTL-009', 'CTL-015', 'CTL-016'] },
    },
    gaps: [
      { subcategory: 'GOVERN-1.2', description: 'AI risk tolerance not documented', severity: 'high', recommendation: 'Document organizational AI risk tolerance.' },
      { subcategory: 'GOVERN-5.2', description: 'AI accountability structure not formalized', severity: 'medium', recommendation: 'Formalize AI accountability roles.' },
      { subcategory: 'MAP-1.2', description: 'AI system context mapping incomplete', severity: 'medium', recommendation: 'Complete system context documentation.' },
      { subcategory: 'MANAGE-4.3', description: 'AI incident recovery procedures not tested', severity: 'high', recommendation: 'Conduct recovery procedure drills.' },
    ],
...
function buildChecklist(): AuditChecklistItem[] {
  return [
    { id: 'ACK-01', category: 'Documentation', item: 'AI management system policy', status: 'passed', evidence: 'AGENTS.md + Security module docs' },
    { id: 'ACK-02', category: 'Documentation', item: 'Risk assessment methodology', status: 'passed', evidence: 'RedTeamFramework 44-scenario battery' },
    { id: 'ACK-03', category: 'Controls', item: 'Input filtering and content scanning', status: 'passed' },
    { id: 'ACK-04', category: 'Controls', item: 'Output sanitization', status: 'passed' },
    { id: 'ACK-05', category: 'Controls', item: 'AI system monitoring and anomaly detection', status: 'passed' },
    { id: 'ACK-06', category: 'Controls', item: 'Access control and authorization', status: 'passed' },
    { id: 'ACK-07', category: 'Controls', item: 'Audit trail with tamper evidence', status: 'passed' },
    { id: 'ACK-08', category: 'Controls', item: 'Incident response procedures', status: 'passed' },
    { id: 'ACK-09', category: 'Controls', item: 'Disaster recovery / business continuity', status: 'passed' },
    { id: 'ACK-10', category: 'Testing', item: 'Regular adversarial testing', status: 'passed' },
    { id: 'ACK-11', category: 'Testing', item: 'Regression testing for security controls', status: 'passed' },
    { id: 'ACK-12', category: 'Compliance', item: 'EU AI Act compliance reporting', status: 'passed' },
    { id: 'ACK-13', category: 'Compliance', item: 'Third-party security audit', status: 'pending', notes: 'Schedule external auditor.' },
    { id: 'ACK-14', category: 'Documentation', item: 'Model cards for AI systems', status: 'pending', notes: 'Document model versions and capabilities.' },
    { id: 'ACK-15', category: 'Documentation', item: 'Data protection impact assessment (DPIA)', status: 'pending', notes: 'Required under GDPR Article 35.' },
    { id: 'ACK-16', category: 'Testing', item: 'Fuzz testing in CI/CD pipeline', status: 'passed', evidence: 'FuzzTestFramework — 6 strategies, coverage-guided' },
    { id: 'ACK-17', category: 'Controls', item: 'Post-quantum cryptographic readiness', status: 'passed', evidence: 'SHA-512 double-hash, 512-bit HMAC keys' },
    { id: 'ACK-18', category: 'Controls', item: 'Multi-agent attack chain detection', status: 'passed', evidence: 'CrossAgentCorrelator — 6 correlation rules' },
    { id: 'ACK-19', category: 'Controls', item: 'Dynamic threat intelligence feed', status: 'passed', evidence: 'ThreatIntelFeed — TLP 4-level, 8 emerging sigs' },
