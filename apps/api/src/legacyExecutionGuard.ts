 ...
 * development. Production, enterprise profile, and explicit V2 mode must never
 * mount or execute it. Keeping this decision in one module prevents individual
 * routers from accidentally reintroducing a second execution authority.
 */
...
export function legacyExecutionDisabledReason(): string {
  if (isEnterpriseProfile()) return 'legacy execution is forbidden in the enterprise profile';
