  ...
  it('retains only the canonical migration identifier, phase, and SQLSTATE', () => {
    ...
    const result = diagnostic!(
      [
        ...
        'Migration failed: COMMANDER_MIGRATION_FAILED;owner_stage=lifecycle_candidate_peer_validation;migration=2026-07-27.3.task1_authenticated_tenant_authority_enforce;phase=enforce;sqlstate=42P01',
        'owner-job-opaque-marker-4820',
      ].join('\n'),
    );
    ...
    assert.match(
      result,
      /^code=COMMANDER_MIGRATION_FAILED;producer=owner_entrypoint;transport=kubectl_logs;owner_stage=lifecycle_candidate_peer_validation;migration=2026-07-27\.3\.task1_authenticated_tenant_authority_enforce;phase=enforce;sqlstate=42P01;log_sha256=[a-f0-9]{64}$/,
    );
