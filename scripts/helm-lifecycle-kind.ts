...
const LIFECYCLE_FAILURE_DIAGNOSTIC =
  /(?:COMMANDER_MIGRATION_FAILED|COMMANDER_PROOF_FAILED|COMMANDER_API_FAILED) stage=[a-z0-9-]+ code=[A-Z0-9_]{2,80}(?: detail=[A-Za-z0-9_.:/-]{1,200})?/g;
