...
const DIAGNOSTIC_CODES = [
  ...
  'TENANT_CUTOVER_OWNER_JOB_POD_UNSCHEDULABLE',
  'TENANT_CUTOVER_OWNER_JOB_POD_IMAGE_PULL_FAILED',
  'TENANT_CUTOVER_OWNER_JOB_POD_CONTAINER_CONFIG_ERROR',
  'TENANT_CUTOVER_OWNER_JOB_POD_CONTAINER_START_FAILED',
  'TENANT_CUTOVER_OWNER_JOB_POD_PENDING',
  'TENANT_CUTOVER_OWNER_JOB_POD_UNCLASSIFIED',
  'TENANT_CUTOVER_MIGRATION_HOOK_POD_UNAVAILABLE',
  ...
  'TENANT_CUTOVER_MIGRATION_HOOK_POD_CONTAINER_START_FAILED',
  'TENANT_CUTOVER_MIGRATION_HOOK_POD_PENDING',
  'TENANT_CUTOVER_MIGRATION_HOOK_POD_UNCLASSIFIED',
  'TENANT_CUTOVER_PROOF_HOOK_POD_UNAVAILABLE',
  ...
  'TENANT_CUTOVER_PROOF_HOOK_POD_CONTAINER_START_FAILED',
  'TENANT_CUTOVER_PROOF_HOOK_POD_PENDING',
  'TENANT_CUTOVER_PROOF_HOOK_POD_UNCLASSIFIED',
  ...
  'TENANT_CUTOVER_KUBECTL_CREATE_NETWORK_POLICY_FAILED',
